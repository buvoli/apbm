module tools_mod
    ...
    ! Interpolation, integration coefficients
    include "functions/interpw.f90"
    include "functions/quadw.f90"
    ...
    include "subroutines/read_cvector.f90"
    ...
    include "functions/ZEYE.f90"
    include "functions/DEYE.f90"
    ...
    include "functions/legpts.f90"
    include "functions/radaupts.f90"
    ...
    include "functions/ZINV.f90"

    include "subroutines/DLU.f90"
    include "functions/DLUS.f90"
    include "functions/DINV.f90"
